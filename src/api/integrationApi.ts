...
export const listEdi = () => apiClient.get<EDIMessage[]>('/api/v1/integration/edi').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listPayments = () => apiClient.get<PaymentTxn[]>('/api/v1/integration/payments').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listSignatures = () => apiClient.get<SignatureRequest[]>('/api/v1/integration/signatures').then(r => Array.isArray(r.data) ? r.data : [])
