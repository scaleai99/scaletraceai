...
export const listApqp = () => apiClient.get<APQPPackage[]>('/api/v1/qms-ext/apqp').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listAudits = () => apiClient.get<InternalAudit[]>('/api/v1/qms-ext/audits').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listMrm = () => apiClient.get<ManagementReview[]>('/api/v1/qms-ext/management-reviews').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listBins = () => apiClient.get<StockBin[]>('/api/v1/inventory-ext/bins').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listTransfers = () => apiClient.get<InternalTransfer[]>('/api/v1/inventory-ext/transfers').then(r => Array.isArray(r.data) ? r.data : [])
...
export const listCounts = () => apiClient.get<CycleCount[]>('/api/v1/inventory-ext/cycle-counts').then(r => Array.isArray(r.data) ? r.data : [])
